...
(function() {
  var Server, chokidar, defaultExclusions, defaultExts, defaultPort, fs, http, path, url, version, ws;
  ...
  Server = (function() {
    function Server(config) {
      ...
      if ((_base6 = this.config).interval == null) {
        _base6.interval = 1000;
      }
      this.sockets = [];
    }
    ...
    Server.prototype.watch = function(dirname) {
      ...
      return this.walkTree(dirname, function(err, filename) {
        ...
        return watcher.on('unlink', function(filename) {
          return _this.refresh(filename);
        });
      });
    };
